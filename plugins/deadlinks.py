#CREDITS: https://github.com/silentlamb/pelican-deadlinks/tree/8b49b594591ded55ba20b74c54c12a566fe8e9cc
# -*- coding: utf8 -*-
...
def content_written(instance):
    ...
    with open(instance.path,'r') as fi:
        _content = fi.read()
    ...
    cache = {}
    soup_doc = BeautifulSoup(_content, 'html.parser')
